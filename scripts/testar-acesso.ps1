...
try {
  ...
  & node --test (Join-Path $tempRoot "core\acesso\service.test.js") (Join-Path $tempRoot "lib\acesso\acesso.repository.test.js") (Join-Path $tempRoot "lib\organizacao\organizacao.repository.test.js") (Join-Path $tempRoot "services\acesso.service.test.js")
