...
export { contextoOperacionalCorrespondeAUnidade, criarContextoOperacionalDaUnidade, derivarContextoOperacionalAtivo, possuiPermissao, unidadePertenceAoTerritorio, vinculoPossuiTerritorioValido } from "./service";
