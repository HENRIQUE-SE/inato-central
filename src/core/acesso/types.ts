...
export type VinculoAcesso = { readonly id: string; readonly usuarioId: string; readonly redeId: string; readonly operacaoId: string | null; readonly areaOperacionalId: string | null; readonly empresaId: string; readonly unidadeId: string | null; readonly escopoTipo: CodigoEscopoAcesso; readonly perfilId: string; readonly ativo: boolean; readonly criadoEm: string };
